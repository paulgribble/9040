...
- LWP 1: [The way of the program](https://openbookproject.net/thinkcs/python/english3e/way_of_the_program.html)
- LWP 2: [Variables, expressions and statements](https://openbookproject.net/thinkcs/python/english3e/variables_expressions_statements.html)
- PDA 1: [Preliminaries](https://wesmckinney.com/book/preliminaries.html)
- PDA 2: [Python Language Basics, iPython, and Jupyter Notebooks](https://wesmckinney.com/book/python-basics.html)
